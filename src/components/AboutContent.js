...
const AboutContent = () => {
  return (
    <div className="about">
        <div className="left">
            <h1>Who Am I?</h1>
            <p>Motivated second year software engineering student with a focus in AI/ML @ uOttawa seeking winter 2024 internship opportunities | Python, Java, JavaScript, React, Flask</p>
